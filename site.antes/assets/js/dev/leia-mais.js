...
$(function () {
    ...
    if (!redirMobile()) {
        $(document).bind('mousemove', function (e) {
            ...
            if ( posicao <= 5 &&   display == "none" && !$('div#auxiliar').hasClass('aberto') &&  url != 'leia-mais/2' && url !='conheca-a-volpato' ) {
    ...
    if (!redirMobile()) {
        $(window).scroll(function () {
            ...
            if ($(window).scrollTop() <= 175) {
                $('div#home div#form').css({position: 'absolute', top: '175px'});
            }
        });
    }
});//documentt
...
function abrirMenuMobile() {
    if ($('div#menu-superior').css('display') == 'none')
        $('div#menu-superior').show();
    else
        $('div#menu-superior').hide();
}
