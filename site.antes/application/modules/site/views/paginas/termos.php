...
<div id="banner-termos-de-uso" class="row">
    <div class="col-md-12">
        <div class="container text-center">
            <div class="row">
                <div class="col-md-12"><h1 class="title-banner">TERMOS DE USO</h1></div>
            </div>
        </div>    
    </div>
</div>
...
<div  class="container" id="termos-uso">
    <div class="col-md-12">
        <h2  class="_font_title text-center "  title="LEIA ATENCIOSAMENTE OS TERMO ABAIXO">LEIA ATENCIOSAMENTE OS TERMO ABAIXO</h2><br>
    </div>
    <div class="col-md-12">
